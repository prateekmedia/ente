...
enum PeopleBannerType { addName, suggestion }
...
class PeopleBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (type) {
      case PeopleBannerType.suggestion:
        ...
        startWidget = Padding(
          ...
          child: Icon(startIcon!, size: 40, color: colorScheme.primary500),
        );
    ...
    if (type == PeopleBannerType.suggestion) {
      return SafeArea(top: false, child: RepaintBoundary(child: banner));
    } else {
